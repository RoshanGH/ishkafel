...
void main() {
  group('时间线轨道总高与窗口尺寸的关系', () {
    test('四条轨加标题条后的总高有明确出处，避免悄悄涨过可用高度', () {
      // 20 + 4 + (14+44) + 4 + (14+26) + 4 + (14+52) + 4 + (14+34)
      expect(TimelineTracks.totalHeight, 248);
    });

    test('最小窗口尺寸下时间线区仍放得下全部四条轨', () {
      ...
      // 三栏区 : 时间线区 = 3 : 2
      final timelineArea = bodyHeight * 2 / 5;
